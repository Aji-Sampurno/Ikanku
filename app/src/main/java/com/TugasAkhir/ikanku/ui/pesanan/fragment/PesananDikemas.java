package com.TugasAkhir.ikanku.ui.pesanan.fragment;
...
import com.TugasAkhir.ikanku.adapter.AdapterPesanan;
...
public class PesananDikemas extends Fragment {
    ...
    private void loadJson(boolean showProgressDialog)
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_DAFTARPESANANDIKEMAS +  Preferences.getKeyIdPengguna(getActivity()),null,
