...
import com.TugasAkhir.ikanku.adapter.AdapterDataProdukEdit;
import com.TugasAkhir.ikanku.model.ModelDataProduk;
import com.TugasAkhir.ikanku.ui.penjual.PenjualTambahProduk;
...
//                DaftarProduk();
    ...
    private void loadJson(boolean showProgressDialog)
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, ServerApi.URL_DAFTARPRODUK +  Preferences.getKeyIdPengguna(getActivity()),null,
