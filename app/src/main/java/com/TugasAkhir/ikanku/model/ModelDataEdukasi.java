...
public class ModelDataEdukasi {String idedukasi, judul, kategoriedukasi, isi, link, gambaredukasi;

    public ModelDataEdukasi(){}

    public ModelDataEdukasi(String idedukasi, String judul, String kategoriedukasi, String isi, String link, String gambaredukasi) {
