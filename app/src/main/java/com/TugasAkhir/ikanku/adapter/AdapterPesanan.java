...
import com.TugasAkhir.ikanku.ui.pesanan.DetailPesanan;
import com.TugasAkhir.ikanku.util.FormatCurrency;

import java.util.List;

public class AdapterPesanan extends RecyclerView.Adapter<AdapterPesanan.HolderData> {
    private List<ModelDataPesanan> mItems ;
    private Context context;

    public AdapterPesanan(Context context, List<ModelDataPesanan> items)
    {
        this.mItems = items;
    ...
    @Override
    public AdapterPesanan.HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.daftarpesanan,parent,false);
        HolderData holderData = new HolderData(layout);
        return holderData;
    }

    @Override
    public void onBindViewHolder(AdapterPesanan.HolderData holder, int position) {
        ...
        public  HolderData (View view)
        {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent update = new Intent(context, DetailPesanan.class);
