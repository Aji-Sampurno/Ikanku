...
import com.TA.ikanku.ui.pesanan.DetailPesananSelesai;
import com.TA.ikanku.util.FormatCurrency;

import java.util.List;

public class AdapterPesananSelesai extends RecyclerView.Adapter<AdapterPesananSelesai.HolderData> {
    private List<ModelDataPesanan> mItems ;
    private Context context;

    public AdapterPesananSelesai(Context context, List<ModelDataPesanan> items)
    {
        this.mItems = items;
    ...
    @Override
    public AdapterPesananSelesai.HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.daftarpesananselesai,parent,false);
        HolderData holderData = new HolderData(layout);
        return holderData;
    }

    @Override
    public void onBindViewHolder(AdapterPesananSelesai.HolderData holder, int position) {
        ...
        public  HolderData (View view)
        {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent update = new Intent(context, DetailPesananSelesai.class);
