...
public class AdapterPenjualanDikirim extends RecyclerView.Adapter<AdapterPenjualanDikirim.HolderData> {private List<ModelDataPesanan> mItems ;
    private Context context;

    public AdapterPenjualanDikirim(Context context, List<ModelDataPesanan> items)
    {
        this.mItems = items;
    ...
    @Override
    public AdapterPenjualanDikirim.HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterPenjualanDikirim.HolderData holder, int position) {
