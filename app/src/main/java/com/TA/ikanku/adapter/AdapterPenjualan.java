...
public class AdapterPenjualan  extends RecyclerView.Adapter<AdapterPenjualan.HolderData> {private List<ModelDataPesanan> mItems ;
    private Context context;

    public AdapterPenjualan(Context context, List<ModelDataPesanan> items)
    {
        this.mItems = items;
    ...
    @Override
    public AdapterPenjualan.HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterPenjualan.HolderData holder, int position) {
