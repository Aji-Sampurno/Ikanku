...
public class AdapterPenjualanSelesai extends RecyclerView.Adapter<AdapterPenjualanSelesai.HolderData> {private List<ModelDataPesanan> mItems ;
    private Context context;

    public AdapterPenjualanSelesai(Context context, List<ModelDataPesanan> items)
    {
        this.mItems = items;
    ...
    @Override
    public AdapterPenjualanSelesai.HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.daftarpenjualan,parent,false);
        HolderData holderData = new HolderData(layout);
        return holderData;
    }

    @Override
    public void onBindViewHolder(AdapterPenjualanSelesai.HolderData holder, int position) {
