...
public class PenjualMain extends AppCompatActivity {
    ...
    private Menu action;
    private static String URL_KERANJANG  ="https://jualanikan.000webhostapp.com/Penjual/Keranjang?idpengguna=";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_KERANJANG +  Preferences.getKeyIdPengguna(PenjualMain.this),null,
