...
public class Akun extends AppCompatActivity {
    ...
    private void pesanandikemas()
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PESANANDIKEMAS +  Preferences.getKeyIdPengguna(Akun.this),null,
    ...
    private void pesanandikirim()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(Akun.this);
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PESANANDIKIRIM +  Preferences.getKeyIdPengguna(Akun.this),null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        for(int i = 0 ; i < response.length(); i++)
    ...
    private void pesananditerima()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(Akun.this);
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PESANANDITERIMA +  Preferences.getKeyIdPengguna(Akun.this),null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        for(int i = 0 ; i < response.length(); i++)
