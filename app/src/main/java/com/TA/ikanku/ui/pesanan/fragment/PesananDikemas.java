...
public class PesananDikemas extends Fragment {
    ...
    String getId;
    private static String URL_DAFTARPESANAN="https://jualanikan.000webhostapp.com/Penjual/ListPesananDikemas?pembeli=";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View root = inflater.inflate(R.layout.fragment_pesanan_dikemas, container, false);
