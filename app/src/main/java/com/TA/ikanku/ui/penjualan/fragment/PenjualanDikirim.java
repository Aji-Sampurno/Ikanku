...
import com.TA.ikanku.adapter.AdapterPenjualan;
...
public class PenjualanDikirim extends Fragment {
    ...
    String                      getId;
    private static String URL_DAFTARPENJUALAN="https://jualanikan.000webhostapp.com/Penjual/ListPenjualanDikirim?idpenjual=";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View root = inflater.inflate(R.layout.fragment_penjualan_dikirim, container, false);
    ...
    private void loadJson(boolean showProgressDialog)
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_DAFTARPENJUALAN +  Preferences.getKeyIdPengguna(getActivity()),null,
