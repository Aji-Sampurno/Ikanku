...
import com.TA.ikanku.ui.Penjualan;
...
public class PenjualLaporan extends Fragment {
    ...
    private static String URL_PENDAPATAN      ="https://jualanikan.000webhostapp.com/Penjual/Pendapatan?idpenjual=";
    private static String URL_PENGELUARAN     ="https://jualanikan.000webhostapp.com/Penjual/Pengeluaran?idpenjual=";
    private static String URL_PESANANBARU     ="https://jualanikan.000webhostapp.com/Penjual/PenjualanBaru?idpenjual=";
    private static String URL_PESANANDIKIRIM  ="https://jualanikan.000webhostapp.com/Penjual/PenjualanDikirim?idpenjual=";
    private static String URL_PESANANSELESAI  ="https://jualanikan.000webhostapp.com/Penjual/PenjualanSelesai?idpenjual=";
    ...
    private void pendapatan()
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PENDAPATAN +  Preferences.getKeyIdPengguna(getActivity()),null,
    ...
    private void pengeluaran()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(getActivity());
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PENGELUARAN+  Preferences.getKeyIdPengguna(getActivity()),null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        FormatCurrency currency = new FormatCurrency();
    ...
    private void pesananbaru()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(getActivity());
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PESANANBARU +  Preferences.getKeyIdPengguna(getActivity()),null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
    ...
    private void pesanandikirim()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(getActivity());
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PESANANDIKIRIM +  Preferences.getKeyIdPengguna(getActivity()),null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        for(int i = 0 ; i < response.length(); i++)
    ...
    private void pesananselesai()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(getActivity());
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PESANANSELESAI +  Preferences.getKeyIdPengguna(getActivity()),null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        for(int i = 0 ; i < response.length(); i++)
