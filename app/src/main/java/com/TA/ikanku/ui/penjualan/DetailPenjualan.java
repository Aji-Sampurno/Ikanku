package com.TA.ikanku.ui.penjualan;
...
public class DetailPenjualan extends AppCompatActivity {
    ...
    private static String URL_KIRIMPESANAN   ="https://jualanikan.000webhostapp.com/Penjual/KirimPesanan";
    ...
    private void kirim_pesanan() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_KIRIMPESANAN,
