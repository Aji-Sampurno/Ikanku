...
import com.TA.ikanku.MainActivity;
import com.TA.ikanku.R;
import com.TA.ikanku.adapter.ItemAdapter;
import com.TA.ikanku.model.ModelData;
import com.TA.ikanku.util.DatabaseHelper;
import com.TA.ikanku.util.Notifikasi;
...
public class PenjualJadwal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_penjual_jadwal, container, false);

        databaseHelper = new DatabaseHelper(getActivity());
        fab = root.findViewById(R.id.fab);
        itemsListView = root.findViewById(R.id.itemsList);
    ...
    private void scheduleNotification(Notification notification, long delay) {
        Intent notificationIntent = new Intent(getActivity(), Notifikasi.class);
    ...
    private Notification getNotification(String content) {
        ...
        builder.setSmallIcon(R.drawable.ic_akun);
