...
import com.TA.ikanku.adapter.AdapterEdukasi;
...
public class PenjualEdukasi extends Fragment {
    ...
    String getId;
    private static String URL_DAFTAREDUKAI="https://jualanikan.000webhostapp.com/Penjual/Edukasi";
    ...
    private void loadJson(boolean showProgressDialog)
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_DAFTAREDUKAI,null,
