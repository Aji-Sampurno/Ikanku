...
import com.TA.ikanku.ui.Login;
import com.TA.ikanku.ui.PengaturanAkun;
import com.TA.ikanku.R;
import com.TA.ikanku.ui.RegistrasiPenjual;
import com.TA.ikanku.ui.SessionManager;
import com.TA.ikanku.ui.Pesanan;
...
public class PembeliAkun extends Fragment {
    ...
    private static String URL_PESANANDIKEMAS  ="https://jualanikan.000webhostapp.com/Penjual/PesananDikemas?pembeli=";
    private static String URL_PESANANDIKIRIM  ="https://jualanikan.000webhostapp.com/Penjual/PesananDikirim?pembeli=";
    private static String URL_PESANANDITERIMA ="https://jualanikan.000webhostapp.com/Penjual/PesananDiterima?pembeli=";
    ...
    private void pesanandikemas()
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PESANANDIKEMAS +  Preferences.getKeyIdPengguna(getActivity()),null,
    ...
    private void pesananditerima()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(getActivity());
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_PESANANDITERIMA +  Preferences.getKeyIdPengguna(getActivity()),null,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        for(int i = 0 ; i < response.length(); i++)
