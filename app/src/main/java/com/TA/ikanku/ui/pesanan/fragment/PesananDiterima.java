package com.TA.ikanku.ui.pesanan.fragment;
...
import com.TA.ikanku.adapter.AdapterPesananSelesai;
...
public class PesananDiterima extends Fragment {
    ...
    String getId;
    private static String URL_DAFTARPESANAN="https://jualanikan.000webhostapp.com/Penjual/ListPesananDiterima?pembeli=";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View root = inflater.inflate(R.layout.fragment_pesanan_diterima, container, false);
        ...
        mAdapter        = new AdapterPesananSelesai(getActivity(),mItems);
    ...
    private void loadJson(boolean showProgressDialog)
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, URL_DAFTARPESANAN +  Preferences.getKeyIdPengguna(getActivity()),null,
